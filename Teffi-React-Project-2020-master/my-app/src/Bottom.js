...
return <div>
  <article className="about" id="about">
    ...
    <div className="pomodoro-text tl">
      ...
      traditionally 25 minutes in length, separated by short breaks either 5 minutes or 10 minutes. Each
    ...
    <img src={tomatoPic} href="#top-container" className="tomato-img grow ma4" alt="tomato-timer-image" />
